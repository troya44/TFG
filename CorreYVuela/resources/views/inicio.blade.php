  ...
  <main>
    <section class="main-content animate-fadein" id="inicio">
      ...
      <p style="font-size:1.15rem; max-width:700px; margin:auto; margin-bottom:1.5rem; color:#444;">
        En Corre Y Vuela, creemos que el deporte es mucho más que una competición: es una oportunidad para superarse,
        compartir experiencias y vivir emociones inolvidables. Nuestra misión es ofrecerte eventos únicos que combinan
        el espíritu deportivo con la magia de la tecnología y el espectáculo.
      </p>
      <h3 style="color:#bfae9c;">"Tu mejor versión te está esperando en la línea de salida. ¿Estás listo para el reto?"
      </h3>
    </section>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.1s;" id="valores">
      ...
      <ul style="margin-left: 1.5rem; margin-bottom: 1.2rem;">
        ...
        <li><b>Innovación:</b> Integramos tecnología audiovisual de última generación para crear experiencias
          memorables.</li>
        <li><b>Inclusividad:</b> Nuestros eventos están abiertos a todos, sin importar edad, condición física o
          experiencia previa.</li>
        <li><b>Compromiso social:</b> Apoyamos causas solidarias y fomentamos la integración a través del deporte.</li>
        <li><b>Excelencia organizativa:</b> Nos esforzamos por ofrecer la máxima calidad en cada detalle, desde la
          inscripción hasta la meta.</li>
      </ul>
      <p>Nuestra visión es ser un referente nacional en la organización de eventos deportivos innovadores, donde cada
        participante y espectador se lleve un recuerdo imborrable.</p>
    </section>
      ...
      <div class="blog-grid">
        <article class="blog-entry">
          ...
          <div class="blog-entry-content">
            ...
            <div class="full-content">
              <p>En la edición de la San Silvestre Olvereña del año pasado, conocimos a Miguel Ángel, un corredor con
                movilidad reducida que completó el recorrido con una prótesis especial. Su esfuerzo, perseverancia y
                pasión por el deporte inspiraron a todos los presentes. Miguel nos enseñó que no existen límites cuando
                hay determinación y apoyo, que con empeño y perseverancia todo se consigue. Su historia es un ejemplo de
                superación y motivación para toda la comunidad deportiva. Cuando Miguel Ángel cruzó la meta, muchos de
                los corredores y personas del público se emocionaron y juntos le rindieron un homenaje en forma de
                aplausos y buenas palabras.</p>
              <p>Todos los años, cuando anunciamos la fecha para el evento, Miguel Ángel es el primero en apuntarse y no
                perderse nada.</p>
        ...
        <article class="blog-entry">
          ...
          <div class="blog-entry-content">
            ...
            <div class="full-content">
              <p>La historia de Corre Y Vuela comenzó en un pequeño pueblo de la Sierra de Cádiz, en Olvera. Un joven
                apasionado por el deporte y la tecnología decidió unir sus fuerzas para crear eventos únicos. Hoy, esa
                ilusión se ha convertido en una empresa referente en la organización de eventos deportivos con
                espectáculos audiovisuales. El creador se llama Guillermo Troya Albarrán y su pasión por el deporte y la
                tecnología lo llevó a crear una empresa que combina ambas disciplinas. Desde sus inicios, ha trabajado
                incansablemente para ofrecer eventos de calidad, donde los corredores puedan disfrutar de una
                experiencia única y emocionante, junto con sus acompañantes y todo el público que se acerque al lugar.
              </p>
            </div>
            <button class="blog-entry-link">Leer más</button>
          </div>
        ...
        <article class="blog-entry">
          ...
          <div class="blog-entry-content">
            ...
            <div class="full-content">
              <p>Detrás de cada evento de Corre Y Vuela existe un equipo multidisciplinario que dedica entre 12 y 14
                horas de trabajo intenso y coordinado. La jornada comienza mucho antes de la llegada de los corredores,
                con la preparación minuciosa de la logística: montaje de carpas, señalización de rutas, instalación de
                puntos de hidratación y coordinación con los equipos de seguridad y primeros auxilios. Paralelamente, se
                supervisa la tecnología audiovisual, pruebas de sonido, pantallas y cronometraje, asegurando que cada
                detalle esté listo para el espectáculo.</p>
              <p>Durante el evento, el equipo permanece atento a cualquier imprevisto, gestionando desde la entrega de
                dorsales hasta la atención de los participantes y el público. La comunicación constante entre las
                distintas áreas es clave para que todo fluya sin contratiempos, permitiendo que corredores y
                espectadores vivan una experiencia memorable desde el inicio hasta la meta. Al finalizar la jornada, aún
                queda desmontar, limpiar y evaluar cada aspecto, cerrando un ciclo de esfuerzo y dedicación que muchas
                veces pasa desapercibido, pero es fundamental para el éxito de cada carrera.</p>
            </div>
            <button class="blog-entry-link">Leer más</button>
          </div>
        </article>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.18s;" id="testimonios">
      ...
      <blockquote
        style="font-style:italic; background:#f3f3f3; border-left:5px solid #ffb76b; margin:1.5rem 0; padding:1rem 1.5rem;">
        "Participar en Corre Y Vuela fue una de las mejores experiencias deportivas de mi vida. La organización, el
        ambiente y el espectáculo audiovisual hicieron que me sintiera como un auténtico protagonista."
        <br>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.2s;" id="quienes">
      <h1>¿Quiénes somos?</h1>
      <p>Corre Y Vuela es una empresa dedicada a la organización de eventos deportivos con espectáculos audiovisuales.
        Nos especializamos en crear experiencias únicas que combinan deporte, entretenimiento y tecnología.</p>
      <p>Nuestro objetivo es ofrecer eventos inolvidables que no solo resalten el talento deportivo, sino que también
        cautiven a la audiencia con impresionantes espectáculos audiovisuales al aire libre.</p>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.3s;" id="equipo">
      ...
      <p>El éxito de Corre Y Vuela se debe al compromiso y profesionalidad de nuestro equipo, formado por especialistas
        en organización de eventos, técnicos audiovisuales, entrenadores deportivos, voluntarios y colaboradores.
        Juntos, trabajamos para que cada carrera sea un acontecimiento seguro, divertido y emocionante para todos.</p>
    </section>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.3s;" id="galeria">
      ...
      <p>
        Aqui podrás ver todas las fotos de los eventos que hemos realizado. Puedes verlas y descargarlas para tener un
        recuerdo de esos momentos tan especiales.
        <br>
    ...
    <section class="info-section animate-fadein" style="animation-delay: 0.5s;" id="contacto">
      <h1>Contacto</h1>
      <p>¿Tienes dudas, sugerencias o quieres colaborar con nosotros? Escríbenos y te responderemos lo antes posible.
      </p>
